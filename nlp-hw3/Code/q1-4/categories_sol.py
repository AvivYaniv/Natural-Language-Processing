...
rare_words_transformation_rules = [
    ...
    ('containsNumber', regex_rule('.*\d')),                        # Example: Aa123
    ('containsUppercase', regex_rule('.*[A-Z].*')),                # Example: abCde
    ('containsHypen', regex_rule('.*\-.*')),                       # Example: ab-cd
]
